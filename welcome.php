...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="right-container">
            ...
            <!-- <label >User:</label> -->
            <input type="text" class="username" id="label2" value="User:" disabled>

            <input type="text" class="username" id="label1"  value="<?php echo $_SESSION['name'] ?>" disabled>
            <!-- <a href="register.php" target="_blank" class="sub-btn">echo $_SESSION['name']</a> -->
            <!-- <a href="login.php" target="_blank" class="sub-btn">login</a> -->
        </div>
    </nav>
